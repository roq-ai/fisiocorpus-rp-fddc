...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'physiotherapist', 'pilates-instructor', 'owner'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Patient', path: '/patients', entity: 'patient', service: AccessServiceEnum.PROJECT, icon: FiHeart },
